        ...
        <tr>
            ...
            <td style="width:50%; vertical-align:top;">
                <table>
                    ...
                    <tr>
                        <td>NOMOR SJ</td>
                        <td>: {{ $details->pluck('NOSJ')->implode(', ') }}</td>
                    </tr>
                </table>
            </td>
            {{-- KANAN --}}
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            :
                            {{ $arh && $arh->TGLJT
                                ? \Carbon\Carbon::parse($arh->TGLJT)->translatedFormat('l, d F Y')
                                : '-' }}
                        </td>
                    </tr>
                    <tr>
        ...
        <tbody>
            @foreach($details as $row)
                <tr>
                    ...
                    <td class="text-right">
                        {{ number_format($row->DISC ?? 0,0,',','.') }}
                    </td>
                    <td class="text-right">
                        {{ number_format($row->TOTAL ?? 0,0,',','.') }}
                    </td>
                    <td class="text-right">
                        {{ number_format($row->PPN ?? 0,2) }}
                    </td>
                </tr>
            @endforeach
        </tbody>
        ...
        <tr>
            ...
            <td
                style="
                    ...
                    vertical-align:top;
                ">
                Untuk pembayaran mohon di transfer ke rek resmi ;
                <table class="mt-10">
                    <tr>
                        <td style="width:80px;">
                            No.rek
