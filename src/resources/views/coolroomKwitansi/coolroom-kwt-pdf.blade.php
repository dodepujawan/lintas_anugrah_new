...
<body>
    ...
    <table width="100%">
        <tr>
            ...
            <td width="50%">
                ...
                Jl. Raya Sempidi No.9 Badung - Bali
                <br>

                Telp/Fax : (0361) 8947610
                <br>
            ...
            <td width="50%" class="text-right">
                ...
                Jl. Sultan Agung KM 28,5 Bekasi
                <br>
    ...
    <p>
        ...
        <b>
            A/n. PT. Lintas Mitra Anugerah Sejati
        </b>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td width="50%" class="text-right">
                ...
                Denpasar
                {{ \Carbon\Carbon::parse($master->TGLKW)->format('d-m-Y') }}
